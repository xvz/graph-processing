...
public:
  ...
  void apply(icontext_type& context, vertex_type& vertex,
    ...
    // "BUG"FIX: divide RESET_PROB by number of vertices, to match
    // PageRank implementations in Giraph, Mizan, GPS
    const double newval = (1.0 - RESET_PROB) * total
                            + RESET_PROB / context.num_vertices();
