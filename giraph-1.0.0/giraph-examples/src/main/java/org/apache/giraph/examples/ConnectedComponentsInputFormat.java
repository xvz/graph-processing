 ...
 * {@link org.apache.giraph.examples.ConnectedComponentsVertex}.
 *
 * Inputs have long ids, no edge weights, and no vertex values.
 * (Vertex values are set to a long of 0.)
 *
...
public class ConnectedComponentsInputFormat extends
  ...
  public TextVertexReader createVertexReader(InputSplit split,
    ...
    throws IOException {
    return new ConnectedComponentsVertexReader();
  }

  /**
   * Vertex reader associated with {@link ConnectedComponentsInputFormat}.
   */
  public class ConnectedComponentsVertexReader extends
